                    ...
                    <div className="order_review-box border p-4">
                        ...
                        <div className="checkout-review-order">
                                    ...
                                    <tbody>
                                        <tr className="cart_item">                                    
                                            <td className="product-name">
                                                <div className="product-image"><img width="300" height="400" src={img1} className="cartimg" alt="image" loading="lazy" /></div>
                                                <div className="text">
                                        ...
                                        <tr className="cart_item">                                    
                                            <td className="product-name">
                                                <div className="product-image"><img width="300" height="400" src={img2} className="cartimg" alt="image" loading="lazy" /></div>
                                                <div className="text">
                                        ...
                                        <tr className="cart_item">                                    
                                            <td className="product-name">
                                                <div className="product-image"><img width="300" height="400" src={img3} className="cartimg" alt="image" loading="lazy" /></div>
                                                <div className="text">
                                ...
                                <div className="checkout-payment mt-4 pt-3 pb-2">
                                    ...
                                    .</p>
                                    <CustomButton buttonTitle="Place Order" link="/track-order" linkButton="false"/>                                    
                                </div>
                        </div>
                    </div>
                </Col>
