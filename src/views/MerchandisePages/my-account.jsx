                        ...
                        <Tab.Content>
                            <Tab.Pane className="fade" eventKey="first">
                                <div className="myaccount-content text-body p-4">
                                    <p>Hello Jenny (not Jenny? <Link to="/login">Log out</Link>)</p>
                                    <p>From your account dashboard you can view your <Link to="#">recent orders</Link>,
                                ...
                                <Table responsive>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td className="p-3"><Link to="#" className="p-2 bg-primary text-white fs-6"
                                                    download>Product
                                                    Demo</Link>
                                            </td>
                                        </tr>
                            ...
                            <div className="d-flex align-items-center justify-content-between my-5 gap-2 flex-wrap">
                                ...
                                <div className="iq-button">
                                    <Link to="#" className="btn text-uppercase position-relative" data-bs-toggle="collapse"
                                ...
                                <div className="text-body mb-4">
                                    <Form>
                                        <div className="form-group mb-5">
                                            ...
                                            <input type="text" name="first-name" defaultValue="John" className="form-control" required="required" />
                                        </div>
                                        <div className="form-group mb-5">
                                            <label className="mb-2">Last name&nbsp; <span className="text-danger">*</span></label>
                                            <input type="text" name="last-name" defaultValue="deo" className="form-control" required="required" />
                                        </div>
                                        <div className="form-group mb-5">
                                        ...
                                        <div className="form-group mb-5">
                                            ...
                                            <input type="text" name="address" placeholder="House number and street name" defaultValue="4517 Kentucky" className="form-control mb-3 rounded-0" required="required" />
                                        ...
                                        <div className="form-group mb-5">
                                            ...
                                            <input type="text" name="city" defaultValue="Navsari" className="form-control" required="required" />
                                        </div>
                                        <div className="form-group mb-5">
                                        ...
                                        <div className="form-group mb-5">
                                            ...
                                            <input type="text" name="pin code" defaultValue="396321" className="form-control" required="required" />
                                        </div>
                                        <div className="form-group mb-5">
                                            <label className="mb-2">Phone&nbsp; <span className="text-danger">*</span></label>
                                            <input type="tel" name="number" defaultValue="1234567890" className="form-control" required="required" />
                                        </div>
                                        <div className="form-group mb-5">
                                            <label className="mb-2">Email address&nbsp; <span className="text-danger">*</span></label>
                                            <input type="email" name="email" defaultValue="johndeo@gmail.com" className="form-control" required="required" />
                                        </div>
                                        <div className="form-group mb-5">
                                    ...
                                    <Form>
                                        ...
                                        <div className="form-group mb-5">
                                            ...
                                            <input type="text" name="address" placeholder="House number and street name"
                                                defaultValue="4517 Kentucky" className="form-control mb-3 rounded-0" required="required" />
                            ...
                            <form>
                                ...
                                <div className="form-group mb-5">
                                    ...
                                    <input type="text" name="display-name" defaultValue="John" className="form-control" required="required" />
                                </div>
