          ...
          <Row>
            <Col lg="4" md="6">
              <div className="contact-box d-flex gap-3 rounded mb-3 mb-lg-0">
                <img src="/assets/images/pages/box-pattern.webp" className="img-fluid position-absolute top-0 end-0" alt="pattern" />
                ...
                <div style={{zIndex: '1'}}>
                  ...
                  <p className="mb-0">Mail: <Link to="mailto:info@medyapim.com" className="text-white fw-500">info@enquiries.com</Link>
                  </p>
                </div>
              </div>
            </Col>
            <Col lg="4" md="6">
              <div className="contact-box d-flex gap-3 rounded mb-3 mb-lg-0">
                ...
                <div style={{zIndex: '1'}}>
                  ...
                  <p className="mb-0">Mail: <Link to="mailto:info@medyapim.com" className="text-white fw-500">support@enquiries.com</Link>
                  </p>
                </div>
              </div>
            </Col>
            <Col lg="4" md="6">
              <div className="contact-box d-flex gap-3 rounded">
                ...
                <div style={{zIndex: '1'}}>
                  ...
                  <p className="mb-0">Mail: <Link to="mailto:info@medyapim.com" className="text-white fw-500">user@enquiries.com</Link>
                  </p>
                </div>
              </div>
            </Col>
