            ...
            <main className='main-content'>
                <div className='vh-100' style={{ backgroundImage: "url(/assets/images/pages/01.webp)", backgroundSize: 'cover', backgroundRepeat: "no-repeat", position: 'relative', minHeight: '500px' }}>
                    <Container>
                                ...
                                <div className='user-login-card bg-body'>
                                    ...
                                    <Form action='post'>
                                        ...
                                        <Form.Group className="text-end mb-3">
                                            <Link to="/lost-password" className="text-primary fw-semibold fst-italic">Forgot
                                                Password?</Link>
                                        </Form.Group>
                                    ...
                                    <p className="my-4 text-center fw-500 text-white">New to Streamit? <Link to="/register" className="text-primary ms-1">Register</Link></p>
                        ...
                        <li className="">
                            <Link to="https:/www.google.com/" className="position-relative">
                        ...
                        <li className="">
                            <Link to="https:/facebook.com/" className="position-relative">
