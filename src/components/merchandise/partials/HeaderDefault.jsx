                    ...
                    <Collapse in={open4} className="sub-nav list-unstyled">
                      <ul>
                        ...
                        <Collapse in={open7} className="sub-nav list-unstyled">
                          <ul>
                            <Nav.Item as="li">
                              <Link to="/blog-template" className={`${location.pathname === '/blog-template' ? 'active': ''} nav-link`}> Blog Template </Link>
                            </Nav.Item>
                            <Nav.Item as="li">
                              <Link to="/blogs-detail" className={`${location.pathname === '/blogs-detail' ? 'active': ''} nav-link`}> Standard </Link>
                            </Nav.Item>
                            <Nav.Item as="li">
