...
export const getVideosRecommendedForYouAsync = () => (dispatch) => {
  setTimeout(() => {
    dispatch(videos_recommended_for_you(videosRecommendedForYou));
  }, sleepTime);
};
...
export const getBestOfInternationalShowsAsync = () => (dispatch) => {
  setTimeout(() => {
    dispatch(best_of_international_shows(bestOfInternationalShows));
  }, sleepTime);
};
...
export const getShowsWeRecommendAsync = () => (dispatch) => {
  setTimeout(() => {
    dispatch(shows_we_recommend(showsWeRecommend));
  }, sleepTime);
};
